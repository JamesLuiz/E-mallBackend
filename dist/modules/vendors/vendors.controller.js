...
let VendorsController = class VendorsController {
    ...
    async create(userId, createVendorDto) {
        ...
        return (0, class_transformer_1.plainToInstance)(vendor_response_dto_1.VendorResponseDto, vendor.toObject());
    }
    async findAll(query) {
        const vendors = await this.vendorsService.findAll(query);
        return (0, class_transformer_1.plainToInstance)(vendor_response_dto_1.VendorResponseDto, vendors.map(vendor => vendor.toObject()));
    }
