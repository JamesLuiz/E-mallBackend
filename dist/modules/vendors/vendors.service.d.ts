...
export declare class VendorsService {
    ...
    uploadLogo(userId: string, file: Express.Multer.File): Promise<VendorDocument>;
    uploadKycDocument(userId: string, file: Express.Multer.File, type: string): Promise<VendorDocument>;
}
