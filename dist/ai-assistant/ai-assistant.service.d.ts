...
export declare class AiAssistantService {
    ...
    handleBlogContentRequest(userId: string, data: any): Promise<{
        message: string;
        suggestions: any[];
    }>;
    handleContentSuggestions(userId: string, data: any): Promise<{
        message: string;
        suggestions: string[];
    }>;
    generateAutoTags(content: string): Promise<string[]>;
    suggestContentImprovements(content: string): Promise<string>;
    generateTitleSuggestions(content: string): Promise<string[]>;
    generateContentIdeas(topic: string, category: string): Promise<string[]>;
    ...
    detectPlagiarism(content: string): Promise<{
        isOriginal: boolean;
        similarityScore: number;
        potentialSources: string[];
    }>;
    generateContentReport(content: string): Promise<{
        wordCount: number;
        readingTime: number;
