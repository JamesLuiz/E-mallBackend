...
export declare class AiAssistantController {
    ...
    generateAutoTags(userId: string, body: {
        content: string;
    }): Promise<{
        tags: string[];
    }>;
    improveContent(userId: string, body: {
        content: string;
    }): Promise<{
        improvements: string;
    }>;
    suggestTitles(userId: string, body: {
        content: string;
    }): Promise<{
        titles: string[];
    }>;
    generateContentIdeas(userId: string, body: {
        topic: string;
        category: string;
    }): Promise<{
        ideas: string[];
    }>;
    moderateContent(userId: string, body: {
        content: string;
    }): Promise<{
        isApproved: boolean;
        confidence: number;
    ...
    detectPlagiarism(userId: string, body: {
        content: string;
    }): Promise<{
        isOriginal: boolean;
    ...
    generateContentReport(userId: string, body: {
        content: string;
    }): Promise<{
        wordCount: number;
        readingTime: number;
