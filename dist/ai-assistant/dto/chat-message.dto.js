...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'User message to the AI assistant' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], ChatMessageDto.prototype, "message", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, description: 'Existing chat session ID' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], ChatMessageDto.prototype, "sessionId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, description: 'Message context or metadata' }),
    (0, class_validator_1.IsOptional)(),
