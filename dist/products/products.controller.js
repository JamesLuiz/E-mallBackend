...
const vendor_filter_dto_1 = require("./dto/vendor-filter.dto");
const vendor_kyc_update_dto_1 = require("./dto/vendor-kyc-update.dto");
const vendor_rating_update_dto_1 = require("./dto/vendor-rating-update.dto");
let ProductsController = class ProductsController {
    constructor(productsService, vendorsService) {
    ...
    getVendorProductsById(vendorId, filter) {
        return this.productsService.findByVendor(vendorId, filter);
    }
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'search', required: false, description: 'Search vendors by name' }),
    (0, swagger_1.ApiQuery)({ name: 'verified', required: false, description: 'Filter by verification status' }),
    (0, swagger_1.ApiQuery)({ name: 'page', required: false }),
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false }),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [vendor_filter_dto_1.VendorFilterDto]),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "getVendors", null);
__decorate([
    (0, common_1.Get)('vendors/:vendorId/profile'),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "getVendorProfile", null);
__decorate([
    (0, common_1.Get)('vendors/:vendorId/products'),
    (0, swagger_1.ApiOperation)({ summary: 'Get products by specific vendor' }),
    (0, swagger_1.ApiParam)({ name: 'vendorId', description: 'Vendor ID' }),
    (0, swagger_1.ApiQuery)({ name: 'category', required: false }),
    (0, swagger_1.ApiQuery)({ name: 'page', required: false }),
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false }),
    ...
    __metadata("design:paramtypes", [String, product_filter_dto_1.ProductFilterDto]),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "getVendorProductsById", null);
__decorate([
    (0, common_1.Get)('vendors/:vendorId/analytics'),
    (0, swagger_1.ApiOperation)({ summary: 'Get vendor analytics' }),
    (0, swagger_1.ApiParam)({ name: 'vendorId', description: 'Vendor ID' }),
    (0, swagger_1.ApiQuery)({ name: 'period', required: false, description: 'Analytics period' }),
    __param(0, (0, common_1.Param)('vendorId')),
    __param(1, (0, common_1.Query)('period')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "getVendorAnalytics", null);
__decorate([
    (0, common_1.Get)('vendors/verified'),
    (0, swagger_1.ApiOperation)({ summary: 'Get all verified vendors' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "getVerifiedVendors", null);
__decorate([
    (0, common_1.Get)('vendors/top-rated'),
    (0, swagger_1.ApiOperation)({ summary: 'Get top rated vendors' }),
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false, description: 'Number of vendors to return' }),
    __param(0, (0, common_1.Query)('limit')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "getTopRatedVendors", null);
__decorate([
    (0, common_1.Get)('vendors/pending'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get pending vendor verifications (Admin only)' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "getPendingVendors", null);
__decorate([
    (0, common_1.Put)('vendors/:vendorId/approve'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    ...
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "approveVendor", null);
__decorate([
    (0, common_1.Put)('vendors/:vendorId/reject'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    ...
    __metadata("design:paramtypes", [String, String, String]),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "rejectVendor", null);
__decorate([
    (0, common_1.Put)('vendors/:vendorId/suspend'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    ...
    __metadata("design:paramtypes", [String, String, String]),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "suspendVendor", null);
__decorate([
    (0, common_1.Put)('vendors/:vendorId/reactivate'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Reactivate vendor (Admin only)' }),
    (0, swagger_1.ApiParam)({ name: 'vendorId', description: 'Vendor ID' }),
    __param(0, (0, common_1.Param)('vendorId')),
    __param(1, (0, current_user_decorator_1.CurrentUser)('_id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "reactivateVendor", null);
__decorate([
    (0, common_1.Get)('vendors/:vendorId/kyc-status'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN, user_role_enum_1.UserRole.VENDOR),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get vendor KYC status' }),
    (0, swagger_1.ApiParam)({ name: 'vendorId', description: 'Vendor ID' }),
    __param(0, (0, common_1.Param)('vendorId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "getVendorKycStatus", null);
__decorate([
    (0, common_1.Put)('vendors/:vendorId/kyc-verification'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Update vendor KYC verification status (Admin only)' }),
    (0, swagger_1.ApiParam)({ name: 'vendorId', description: 'Vendor ID' }),
    __param(0, (0, common_1.Param)('vendorId')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, current_user_decorator_1.CurrentUser)('_id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, vendor_kyc_update_dto_1.VendorKycUpdateDto, String]),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "updateVendorKycStatus", null);
__decorate([
    (0, common_1.Get)('vendors/kyc/pending'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get vendors with pending KYC verification (Admin only)' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "getPendingKycVerifications", null);
__decorate([
    (0, common_1.Get)('vendors/kyc/:status'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get vendors by KYC verification status (Admin only)' }),
    (0, swagger_1.ApiParam)({ name: 'status', description: 'Verification status', enum: ['pending', 'approved', 'rejected'] }),
    __param(0, (0, common_1.Param)('status')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "getVendorsByKycStatus", null);
__decorate([
    (0, common_1.Put)('vendors/:vendorId/rating'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Update vendor rating (Admin only)' }),
    (0, swagger_1.ApiParam)({ name: 'vendorId', description: 'Vendor ID' }),
    __param(0, (0, common_1.Param)('vendorId')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, vendor_rating_update_dto_1.VendorRatingUpdateDto]),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "updateVendorRating", null);
__decorate([
    (0, common_1.Get)('vendors/:vendorId/dashboard'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "getVendorDashboard", null);
exports.ProductsController = ProductsController = __decorate([
    (0, swagger_1.ApiTags)('Products'),
    (0, common_1.Controller)('products'),
    __metadata("design:paramtypes", [products_service_1.ProductsService, typeof (_a = typeof vendors_service_1.VendorsService !== "undefined" && vendors_service_1.VendorsService) === "function" ? _a : Object])
], ProductsController);
